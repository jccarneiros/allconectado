...
@section('content')
    <div class="card">
        <div class="container">
            <h5 class="card-title" style="border-left: 5px solid #aa00ff;background-color: #f5f5f5;width: 100%;padding: 2px 0px 5px 10px;">Novo usuário</h5>
            <div class="row">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <form action="{{route('dashboard.users.store')}}" method="POST" id="form" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            @include('dashboard.users.partials._roles_create')
                            @include('dashboard.users.partials._permissions_create')
                        </form>
                    </div>
                </div>
            </div>
